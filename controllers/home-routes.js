...
const { getContentData, getPopData, getTopData, createContent, searchContent, getActionData, getComedyData, getRomanceData, youtube 
...
async function createsContent(req, res, type, id, ) {
    try {
      //here is the YouTube logic for getting the video id from the url.
